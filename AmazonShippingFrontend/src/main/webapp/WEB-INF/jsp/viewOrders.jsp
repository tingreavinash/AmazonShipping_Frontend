...
<body style="margin:10px">
	...
	<div class="list-group " id="hflist" style="margin-top:10px;">
		...
		<div class="col col-sm-3 text-center "><b>Order Number</b></div>
		<div class="col col-sm-9 text-center"><b>Buyer Name</b></div>
		</div>
		...
		<a class="list-group-item list-group-item-action hf-details-parent"
			...
			<div class="row hf-list-top">
				<div class="col col-sm-4 ">
					...
					onclick="copyToClipboard('ecpno_${order.order_id}', 'description_${order.order_id}')"><i class="fas fa-copy"></i></span>
		...
		<div class="collapse multi-collapse hf-details-child" style="background-color: white"
			data-parent="#hflist" id="hfCollapse${order.order_id}">
				<div class="bd-callout bd-callout-warning">
					
					<div class="row justify-content-end">
					
					<button class="btn btn-warning btn-sm" style="margin-left: 10px;" onclick="saveImage('ecp_image_${order.order_id}', '${order.order_id}')">
                    ...
                    <div class="row">
                        <div class="col">
                            <div>
                                ...
                                ${order.ship_address_1}<br>${order.ship_address_2}<br>${order.ship_address_3}
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div>
                                <span class="badge badge-pill badge-info hf-detail-tag">Tracking ID</span><br>
                                ${order.tracking_id}
                            </div>
                        ...
                        <div class="col">
                            <div>
                                <span class="badge badge-pill badge-info hf-detail-tag">Courier Code</span><br>
                                ${order.courier_code}
                            </div>
                        </div>                        
                    </div> 
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div>
                                <span class="badge badge-pill badge-info hf-detail-tag">Last Modified By</span><br>
                                ${order.record_created_by}
                            </div>
                        ...
                        <div class="col">
                            <div>
                                <span class="badge badge-pill badge-info hf-detail-tag">Last Modified On</span><br>
                                ${order.record_last_modified}
                            </div>
                        </div>                        
                    </div> 


					<a href="editemp/${order.order_id}" class="btn btn-success btn-sm" id="updateBtn_${order.order_id}">
					Update
					</a>
		...
		<br>
		<a href="empform" class="btn btn-success btn-sm" id="addEmpBtn_${order.order_id}">
					Add Employee
					</a>
